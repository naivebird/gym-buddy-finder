    ...
    return (
        <div style={styles.container}>
            ...
            <p>
                ...
                This could be due to a variety of reasons, and you may need to contact support for further assistance.
            </p>
            <p>
                If you believe this is an error or would like more information about the suspension, please reach out to our support team.
            </p>
            ...
            <div style={styles.feedbackContainer}>
                <h2>Feedback Form</h2>
                <form action="https://example.com/feedback" method="post" style={styles.feedbackForm}>
